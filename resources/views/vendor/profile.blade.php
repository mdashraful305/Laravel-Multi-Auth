...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Vendor Profile</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
                ...
                <div class="card-body">
                    <div class="tab-content">
                        ...
                        <div class="tab-pane active" id="profile">
                            <form method="POST" action="{{ route('vendor.user.update' ,$user->id ) }}" enctype="multipart/form-data">
                                @csrf
                        ...
                        <div class="tab-pane" id="settings">
                            <form class="form-horizontal" method="POST" action="{{ route('vendor.user.update' ,$user->id ) }}">
                                @csrf
